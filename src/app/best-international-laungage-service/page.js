              ...
              <div className="course-details__tabs tabs-box">
                ...
                <Accordion defaultActiveKey="0">
                  ...
                  <Accordion.Item eventKey="15">
                    ...
                    <Accordion.Body>
                      <p className='course-details__curriculum__text'>Learning English can be fun. At Oracle International Language Institute in Delhi, there is a team of well-trained and dedicated teachers who are known for using a variety of challenging, fun, and interesting classroom techniques for students who want to learn English. These techniques are designed by the experts for developing student’s learning strategies and encourage them to become more independent language learners.</p>
                    </Accordion.Body>
                  </Accordion.Item>
                </Accordion>
              </div>
